...
export default function IntegrationDetailPageClient() {
  ...
  const jsonLd = {
    ...
    offers: {
      "@type": "Offer",
      price: integration.price.type === "free" ? "0" : integration.price.value?.toString(),
      priceCurrency: "CNY",
      availability: "https://schema.org/InStock",
    },
    aggregateRating: {
      "@type": "AggregateRating",
      ratingValue: integration.rating.toString(),
      reviewCount: integration.reviewCount.toString(),
      bestRating: "5",
      worstRating: "1",
    },
    author: {
    ...
    datePublished: integration.releaseDate,
    dateModified: integration.lastUpdate,
